...
final class Version20231116083230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE provider (id INT NOT NULL, name VARCHAR(64) NOT NULL, alias VARCHAR(32) NOT NULL, api_key VARCHAR(32) NOT NULL, api_secret VARCHAR(64) NOT NULL, type provider_type_enum, status is_active_status_enum, extra JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
